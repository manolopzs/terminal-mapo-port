...
const COMPUTE_TICKERS = [
  "VRT", "CIEN", "SMCI", "CRDO", "ANET", "COHR", "PSTG", "NTAP", "EME", "PWR",
  "DELL", "HPE", "JNPR", "VIAV", "LITE", "IIVI", "FORM", "ACM", "DY", "MYRG",
];
...
export async function runComputeScout(): Promise<CandidateTicker[]> {
  ...
  // Sort by marketCap descending, return top N
